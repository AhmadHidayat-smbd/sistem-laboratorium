...
@section('page_title', 'Edit Asisten')
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-10">
            <div class="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h2 class="text-2xl font-black text-gray-800 tracking-tight">Edit Profil Asisten</h2>
                    <p class="text-sm font-medium text-gray-400">Perbarui informasi identitas dan kredensial akses.</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-8">
                ...
                <!-- Password -->
                <div class="space-y-3">
                    <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[2px] ml-2">Ubah Kata Sandi (Opsional)</label>
                    <div class="relative group">
                    ...
                    <p class="text-[10px] font-bold text-amber-600 px-2 flex items-center gap-1">
                        <i class="ph-bold ph-info"></i>
                        Sangat disarankan untuk mengubah kata sandi secara berkala demi keamanan akun.
                    </p>
                </div>
