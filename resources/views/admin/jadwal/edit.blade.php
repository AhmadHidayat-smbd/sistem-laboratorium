    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-10">
            <div class="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h2 class="text-2xl font-black text-gray-800 tracking-tight">Modifikasi Jadwal Kuliah</h2>
                    <p class="text-sm font-medium text-gray-400">Sesuaikan waktu dan hari pelaksanaan praktikum.</p>
                </div>
            </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            ...
                            <select name="hari" required
                                ...
                                @foreach($hariList as $en => $idn)
                                    <option value="{{ $en }}" {{ $jadwal->hari === $en ? 'selected' : '' }}>
                                        {{ $idn }}
                                    </option>
                                @endforeach
                            </select>
